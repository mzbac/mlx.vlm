// Copyied from https://github.com/ml-explore/mlx-swift-examples/blob/main/Libraries/MLXVLM/MediaProcessing.swift
...
public enum MediaProcessing {
    ...
    public static func fitIn(_ size: CGSize, longestEdge: Int) -> CGSize {
        ...
        if long <= floatLongestEdge {
            // No scaling needed
            return size
        }
        
        // Scale down proportionally
        let scale = floatLongestEdge / long
        let newShort = short * scale
        let newLong = floatLongestEdge
